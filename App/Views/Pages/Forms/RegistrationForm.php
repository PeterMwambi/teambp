        ...
        <div class="row p-lg-5 p-md-3 p-2">
            ...
            <div class="col-lg-6 col-md-12 col-12 animate__animated animate__slideInRight">
                ...
                <div class="mt-lg-5 mx-lg-5 my-3 p-md-4 p-lg-4 p-4 border border-secondary rounded">
                    ...
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/registration/step5.php")) ?>
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/registration/step4.php")) ?>
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/registration/step3.php")) ?>
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/registration/step2.php")) ?>
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/registration/step1.php")) ?>
